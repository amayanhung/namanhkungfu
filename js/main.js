$(function() {
  ...
  if ($("div").is("#map")) {
    mapboxgl.accessToken = 'pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4M29iazA2Z2gycXA4N2pmbDZmangifQ.-g_vE53SD2WrJ6tFX7QHmA#16.13';
    var map = new mapboxgl.Map({
      container: 'map',
      style: 'mapbox://styles/mapbox/dark-v10',
      center: [106.6479, 10.80733],
      zoom: 14

    });

    var marker = new mapboxgl.Marker()
      .setLngLat([106.6479, 10.80733])
      .addTo(map);
  }
  ...
  document.addEventListener("swup:contentReplaced", function() {
    ...
    if ($("div").is("#map")) {
      ...
      var map = new mapboxgl.Map({
        container: 'map',
        style: 'mapbox://mapbox://styles/mapbox/dark-v10',
        center: [106.6479, 10.80733],
        zoom: 14
